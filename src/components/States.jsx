...
// const States = () => {
//   return (
//       <div className='flex flex-col justify-center items-center mx-auto my-40 ' id='states-page'>
...
const States = () => {
    return (
        ...
        >
            ...
            <h1 className="text-3xl sm:text-4xl md:text-5xl text-center font-bold text-[#0E2553]">
                Choose Your Location
            </h1>

            <p className="text-center text-[#555] py-5 w-full sm:w-[80%] md:w-[65%] lg:w-[50%]">
                SchoolManagement operates across multiple states in Nigeria with
                localized solutions tailored to your region's educational standards and
                requirements.
            </p>
